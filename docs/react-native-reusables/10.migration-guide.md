...
function OldComponent() {
  ...
  return (
    <View style={{ backgroundColor: theme.colors.background }}>
      ...
      <Button onPress={toggleTheme} title={`Switch to ${isDark ? 'Light' : 'Dark'}`} />
    </View>
  );
}
...
function OldIconUsage() {
  return (
    <Icon name="sun" color="#000000" size={24} />
  );
}
...
function PlainReactNativeComponent() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>This is the card description with plain React Native styles.</Text>
